...
class BaseOptions:
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--src_vocab', type=int, default=258)
        self.parser.add_argument('--tgt_vocab', type=int, default=258)
        ...
        self.parser.add_argument('--net-name', type=str, default='sketchTransfromer')

        self.parser.add_argument('--do-reconstruction', type=bool, default=False)
        self.parser.add_argument('--do-retrieval', type=bool, default=False)
        #transformer
        self.parser.add_argument('--segment-len', type=int, default=20)
        self.parser.add_argument('--stroke-len', type=int, default=20)
        self.parser.add_argument('--sketch-len', type=int, default=40)
        ...
        self.parser.add_argument('--num-layers', type=int, default=8)
        ...
        #for classfication
        self.parser.add_argument('--n-class', type=int, default=345)
        self.parser.add_argument('--do-classification', type=bool, default=True)
        ...
        # self.parser.add_argument('--seqEmb-size', type=int, default=256)
        # self.parser.add_argument('--rasterEmb-size', type=int, default=256)
        # self.parser.add_argument('--shared-size', type=int, default=256)
...
class TrainOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument('--print-freq', type=int, default=1, 
...
class TestOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument('--batch-size', type=int, default=256, help='intout batch size')
        ...
        self.parser.add_argument('--shuffle', type=bool, default=False)
