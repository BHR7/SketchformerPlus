...
class BaseOptions:
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--src_vocab', type=int, default=4)
        self.parser.add_argument('--tgt_vocab', type=int, default=4)
        ...
        #transformer
        self.parser.add_argument('--seq-len', type=int, default=20)
        self.parser.add_argument('--d-model', type=int, default=128)
        self.parser.add_argument('--nhead', type=int, default=8)
        self.parser.add_argument('--low_dim', type=int, default=128)
